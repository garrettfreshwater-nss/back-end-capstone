        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVetrinarian = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PetUser_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    isSpayedOrNeutered = table.Column<bool>(nullable: false),
                    CurrentMedications = table.Column<string>(nullable: true),
                    OngoingProblems = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "00000000-ffff-ffff-ffff-ffffffffffff", 0, "e8b880cf-9a1a-45a6-9d06-17c8a0ab30b4", "admin@admin.com", true, "Admina", null, true, false, "Straytor", false, null, "ADMIN@ADMIN.COM", "ADMIN@ADMIN.COM", "AQAAAAEAACcQAAAAEDO247iTSBrBpV3nDA1AapTt/hp7bjXjg2fHQfuqgJuwi1l6uR13BIzqwNfL3y8/RQ==", null, false, "7f434309-a4d9-48e9-9ebb-8803db794577", false, "admin@admin.com" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PetUser_ApplicationUserId",
                table: "PetUser",
                column: "ApplicationUserId");
        }
